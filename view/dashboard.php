      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-menu">
          <ul>
            ...
            <li><a href="index.php?action=profil">Les profils</a></li>
            <li><a href="index.php?action=enveie">liste d’envie</a></li>
            <li><a href="index.php?action=contact">Nous contacter</a></li>
            <li><a href="index.php?action=updatemyprofil">Mon Profil</a></li>
